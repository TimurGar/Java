/**
 * A client that tests LinkedNumber
...
public class Client
{
	...
	public static void main(String[] args) 
	{
		 ...
		 * Test 6: 925 + 227                            *
		 ************************************************/ 
		a1 = new Node(5); a2 = new Node(2); a3 = new Node(9);
		b1 = new Node(7); b2 = new Node(2); b3 = new Node(2);

		a1.setNext(a2); a2.setNext(a3);
		b1.setNext(b2); b2.setNext(b3);

		s1 = new Node(2); s2 = new Node(5); s3 = new Node(1); s4 = new Node(1);
		s1.setNext(s2); s2.setNext(s3);	s3.setNext(s4);
	...
	public static void sumAndTest(Node a1, Node b1, Node s1)
	{
		...
		System.out.println("Test " + (++count) + " " + (s.equals(c) ? "passed" : "failed") + " " + a + " + " + b + " is " + c);	
	}
}